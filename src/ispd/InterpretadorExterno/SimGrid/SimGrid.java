/* Generated By:JavaCC: Do not edit this line. SimGrid.java */
        ...
        public class SimGrid implements SimGridConstants {
                ...
                public void writefile() throws ParseException, TokenMgrError, IOException
                {
                        ...
                        try
                        {
                                ...
                                for(Route r:routes)
                                        file.format("REDE %s[%d] %s %s 0.0 CONECTA %s %s\u005cn", r.getID(), r.getNet(), r.getBand(), r.getLatency(), r.getSrc(), r.getDst());
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x10000000,0xf8000000,0xf8000000,0xf8000000,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x5f,0x5f,0x5f,0x2,0x2,};
   }
