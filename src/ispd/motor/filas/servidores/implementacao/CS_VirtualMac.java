...
public class CS_VirtualMac extends CS_Processamento
        implements Client, Mensagens {
     ...
     * @param disco
     */
    public CS_VirtualMac(String id, String proprietario,
                         int numeroProcessadores, double memoria,
                         double disco, String OS) {
    ...
    public void chegadaDeCliente(Simulation simulacao, Tarefa cliente) {
        if (cliente.getEstado() != Tarefa.CANCELADO) { //se a tarefa estiver
    ...
    public void saidaDeCliente(Simulation simulacao, Tarefa cliente) {
        ...
        if (Origem.equals(this.vmmResponsavel)) {
            ...
            if (index == -1) {
                ...
                caminho =
                        new ArrayList<CentroServico>(caminhoIntermediarios.get(index));
            }
        }
    ...
    @Override
    public void atenderDevolucaoPreemptiva(Simulation simulacao,
                                           Mensagem mensagem) {
    ...
    public void atenderAtualizacao(Simulation simulacao, Mensagem mensagem) {
        ...
        List<CentroServico> caminho =
                new ArrayList<CentroServico>((List<CentroServico>) caminhoVMM);
        Mensagem novaMensagem = new Mensagem(this,
    ...
    @Override
    public void atenderRetornoAtualizacao(Simulation simulacao,
                                          Mensagem mensagem) {
