...
public class CS_VMM extends CS_Processamento
    ...
    private boolean noAllocatedVms = true;
    ...
    public CS_VMM(
            ...
            final double ignoredMemory, final double ignoredDisk,
        ...
        Objects.requireNonNull(this.alocadorVM).setVMM(this);
        this.escalonador =
    ...
    public void requisicao(final Simulation simulacao,
        ...
        if (tipo == FutureEvent.ESCALONAR) {
            ...
            this.alocadorVM.escalonar();// realizar a rotina de alocar a máquina
            // virtual
    ...
    public void atenderAtualizacao(final Simulation simulacao,
        ...
        final List<CentroServico> caminho = new ArrayList<>(
                CS_Processamento.getMenorCaminhoIndireto(this,
    ...
    public void atenderAckAlocacao(final Simulation simulacao,
        ...
        if (auxVM.getVmmResponsavel().equals(this)) {// se o VMM responsável
            ...
            if (index == -1) {
                caminho =
                        new ArrayList<>(CS_Processamento.getMenorCaminhoIndiretoCloud(this, auxMaq));
            } else {
                caminho =
            ...
            if (this.noAllocatedVms) {
                this.noAllocatedVms = false;
                this.escDisponivel = true;
            }
    ...
    public void determinarCaminhos() throws LinkageError {
        final List<CS_Processamento> escravos =
                this.alocadorVM.getMaquinasFisicas(); //
        // lista de maquinas fisicas
        // Instancia objetos
