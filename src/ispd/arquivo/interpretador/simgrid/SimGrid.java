...
public class SimGrid implements SimGridConstants {
    ...
    private static class Network {
        ...
        public void setAtributos(String id, String band, String latency) {
            System.out.println("Mudando " + this.id + " para " + id);
            this.id = id;
            this.band = band;
    ...
    static final public void xml_version() throws ParseException {
        try {
            jj_consume_token(menor);
            jj_consume_token(interrogacao);
    ...
    static final public void inicio_plataforma() throws ParseException {
        try {
            jj_consume_token(menor);
    ...
    static private boolean jj_3_27() {
        if (jj_scan_token(menor)) {
            return true;
        }
        if (jj_scan_token(ARGUMENT)) {
            return true;
        }
        return false;
    }
    ...
    static private boolean jj_3_26() {
        ...
        if (jj_scan_token(igual)) {
            return true;
        }
        if (jj_scan_token(aspas)) {
            return true;
        }
        if (jj_3R_21()) {
            return true;
        ...
        if (jj_scan_token(barra)) {
            return true;
        }
        if (jj_scan_token(maior)) {
            return true;
        }
        if (jj_scan_token(menor)) {
            return true;
    ...
    static private boolean jj_3_33() {
        ...
        if (jj_scan_token(FORWARDERCOMM)) {
            return true;
        }
        return false;
    }
    ...
    static private boolean jj_3_32() {
        ...
        if (jj_scan_token(FORWARDERNODE)) {
            return true;
        }
        return false;
    }
    ...
    static private boolean jj_3_31() {
        ...
        if (jj_scan_token(FORWARDERSCHEDULER)) {
            return true;
        }
        return false;
    }
    ...
    static private boolean jj_3_34() {
        ...
        if (jj_scan_token(ROUTE_ELEMENT)) {
            return true;
        }
        return false;
    }
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[]{0x10000000, 0xf8000000, 0xf8000000, 0xf8000000, 0x0, 0x0, 0x0, 0x18000000, 0x18000000, 0x18000000, 0x18000000, 0x18000000, 0x3000, 0x0, 0x3000, 0x10008, 0x30, 0x18, 0x28, 0x38, 0x180,};
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[]{0x0, 0x5f, 0x5f, 0x5f, 0x2, 0x30, 0x30, 0x48, 0x40, 0x40, 0x40, 0x40, 0x0, 0x2, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,};
    }
