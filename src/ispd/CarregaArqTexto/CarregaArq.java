/* Generated By:JavaCC: Do not edit this line. CarregaArq.java */
...
class CarregaArq implements CarregaArqConstants {
        ...
        public void resuladoParser(){
                ...
                if(erroEncontrado){
                        ...
                        //JOptionPane.showOptionDialog(null,"Modelo ic�nico reconhecido com sucesso.","Modelo ic�nico reconhecido", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,null,null, null);
  ...
  final public void Link() throws ParseException {
    ...
    try {
      ...
      t6 = jj_consume_token(identificador);
      t7 = jj_consume_token(identificador);
                        if(listaNomes.contains(t2.image)){
                                addErro("There's already an icon named \u005c'"+t2.image+"\u005c'.");
                                erroEncontrado = true;
                        }else{
  ...
  public CarregaArqTokenManager token_source;
  ...
  public CarregaArq(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public CarregaArq(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new CarregaArqTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public CarregaArq(java.io.Reader stream) {
  ...
  public CarregaArq(CarregaArqTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(CarregaArqTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
